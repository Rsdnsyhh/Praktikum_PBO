...
interface AturanSewa {
    public void syaratPinjam();
    public void dendaKerusakan();
}

// parent class diubah jadi abstract class dan mengimplementasikan interface
abstract class AlatCamping implements AturanSewa {
    // private
    ...
    // ABSTRACT METHOD
    // mengubah method ini jadi abstract, diimplementasikan wajib oleh subclass
    public abstract void caraPerawatan();

    // IMPLEMENTASI INTERFACE
    public void syaratPinjam() {
        System.out.println("Syarat     : Wajib meninggalkan kartu identitas asli (KTP/KTM).");
    }

    public void dendaKerusakan() {
        System.out.println("Denda      : Kehilangan/kerusakan wajib mengganti seharga barang baru.");
    }
}
